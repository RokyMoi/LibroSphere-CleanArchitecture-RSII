...
using LIbroSphere.Infrastructure.Authentication.Models;
using System;
...
namespace LbroSphere.Infrastructure.Authentication.Models
{
    //Information that Keycloak stores for user
    internal sealed class UserRepresentationModel
    {
        ...
        //For mapping of user entity to representational model
