...
namespace LibroSphere.Infrastructure.Migrations
{
    ...
    [Migration("20260530003302_AddCartInteractions")]
    partial class AddCartInteractions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibroSphere.Domain.Entities.Recommendations.CartInteraction", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CartInteractions", (string)null);
                });
            ...
            modelBuilder.Entity("LibroSphere.Domain.Entities.Users.UserFavoriteAuthor", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LibroSphere.Domain.Entities.Recommendations.CartInteraction", b =>
                {
                    b.HasOne("LibroSphere.Domain.Entities.Books.Book", null)
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibroSphere.Domain.Entities.Users.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LibroSphere.Domain.Entities.Users.UserFavoriteAuthor", b =>
                {
                    b.HasOne("LibroSphere.Domain.Entities.Authors.Author", null)
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
